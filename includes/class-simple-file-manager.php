...
class Simple_File_Manager {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Simple_File_Manager_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'SIMPLE_FILE_MANAGER_VERSION' ) ) {
			$this->version = SIMPLE_FILE_MANAGER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'simple-file-manager';
	 ...
	 *
	 * - Simple_File_Manager_Loader. Orchestrates the hooks of the plugin.
	 * - Simple_File_Manager_i18n. Defines internationalization functionality.
	 * - Simple_File_Manager_Admin. Defines all hooks for the admin area.
	 * - Simple_File_Manager_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-simple-file-manager-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-simple-file-manager-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-simple-file-manager-admin.php';
	 ...
	 *
	 * Uses the Simple_File_Manager_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Simple_File_Manager_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Simple_File_Manager_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Simple_File_Manager_Loader    Orchestrates the hooks of the plugin.
	 */
